...
lazy_static! {
    ...
    static ref BISHOP_MOVES: MagicTable<512> = init_bishop_moves();
    static ref ROOK_MOVES: MagicTable<4096> = init_rook_moves();
}
...
fn init_bishop_moves() -> MagicTable<512> {
    println!("Searching for bishop magics");
    ...
    MagicTable::<512>::new(&bishop_directions, &BISHOP_MAGICS, &BISHOP_BITS)
}

fn init_rook_moves() -> MagicTable<4096> {
    println!("Searching for rook magics");
    ...
    MagicTable::<4096>::new(&rook_directions, &ROOK_MAGICS, &ROOK_BITS)
}
